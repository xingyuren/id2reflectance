...
class FFHQBlindDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if self.io_backend_opt['type'] == 'lmdb':
            ...
            # self.paths = paths_from_folder('/root/autodl-tmp/data/PBR35-FFHQ-512') + paths_from_folder('/root/autodl-tmp/data/ffhq/ffhq512')
    ...
    def __getitem__(self, index):
        ...
        if self.use_corrupt and not self.gen_inpaint_mask:
            ...
            if self.jpeg_range is not None:
                jpeg_p = int(np.random.uniform(self.jpeg_range[0], self.jpeg_range[1]))
